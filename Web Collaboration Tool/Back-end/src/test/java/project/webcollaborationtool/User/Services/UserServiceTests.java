...
public class UserServiceTests
{
    ...
    {
        var user = new User("username", "password", "a@a.com", null, null, null, null);
    ...
    {
        var user = new User("user", null, null, null, null, null, null);
    ...
    {
        var user = new User("username", "password1", null, null, null, null, null);
    ...
    {
        var user = new User("username", "password", "email@email.com", null, null, null, null);
